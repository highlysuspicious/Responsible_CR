...
public class faculty_notice implements Initializable {
    ...
    public void add_notice(ActionEvent event) throws IOException {

        String t = "Faculty :  " + text.getText();
        text.setText("");

        File infoFile = new File("src/main/resources/com/example/responsible_cr/files/notice.txt");
    ...
    public void delete_notice(ActionEvent event) throws IOException {
